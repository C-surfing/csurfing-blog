...
export const bookmarksData: BookmarkItem[] = [
	...
	{
		id: 30,
		title: "Beej 网络编程指南（简体中文版）",
		imgurl: "",
		desc: "Beej's Guide to Network Programming 中文翻译，Linux socket 网络编程经典教程，第七章实战技巧尤为精彩",
		siteurl: "https://beej-zhcn.netdpi.net/",
		tags: ["网络编程", "计算机网络"],
		category: "408",
	},
	{
		id: 31,
		title: "jyywiki（Yanyan's Wiki）",
		imgurl: "",
		desc: "南京大学蒋炎岩老师的课程主页：操作系统（含 OSTEP 实验）、计算机系统基础等硬核课程与讲义",
		siteurl: "https://jyywiki.cn/",
		tags: ["操作系统", "课程"],
		category: "408",
	},
	{
		...
		title: "一生一芯 · ICS PA",
		imgurl: "",
		desc: "南京大学《计算机系统基础》课程实验：从零实现一个 CPU 的编程作业，配套一生一芯计划",
		siteurl: "https://ysyx.oscc.cc/docs/ics-pa/",
		tags: ["计算机组成", "实验"],
		category: "408",
	},
	{
		...
		title: "VisuAlgo",
		imgurl: "",
		desc: "通过动画可视化数据结构和算法，支持自定义输入，新加坡国立大学出品",
		siteurl: "https://visualgo.net/zh",
		tags: ["算法", "可视化"],
		category: "408",
	},
	{
		...
		title: "Hello 算法",
		imgurl: "",
		desc: "动画图解、一键运行的数据结构与算法教程：500 幅动画图解、14 种语言代码、3000 条社区问答",
	...
	{
		id: 35,
		title: "Missing Semester（中文版）",
		imgurl: "",
		desc: "MIT《计算机教育中缺失的一课》中文翻译：命令行、vim、git、调试等工程实用技能",
		siteurl: "https://missing-semester-cn.github.io/",
		tags: ["工具", "课程"],
		category: "408",
	},
	{
